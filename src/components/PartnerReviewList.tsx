...
import { PendingPartnerType } from "./AdminDashboard";
...
export function PartnerReviewList(
  { partners }: { partners: PendingPartnerType[] }
): React.ReactElement {
  const router = useRouter()
  const [partner, setPartner] = useState<PendingPartnerType[]>([])
  console.log(partner);
  useEffect(() => {
    setPartner(partners)
  },[])
